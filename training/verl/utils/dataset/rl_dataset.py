...
class RLHFDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.original_data_source = copy.deepcopy(self.data_source)  # use for resume
    ...
    def _download(self, use_origin_parquet=False):
        ...
        parquet_files = self.data_source if not use_origin_parquet else self.original_data_source
        for i, parquet_file in enumerate(parquet_files):
            self.data_source[i] = copy_to_local(src=parquet_file, cache_dir=self.cache_dir)
    ...
    def resume_dataset_state(self):
        self.serialize_dataset = False if hasattr(self, 'original_data_source') else True
